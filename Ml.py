...
rad = st.sidebar.radio("",["Home","Abstract","Libraries","Dataset","Linear Regression","Lasso Regression"])
...
with header:
    ...
    if rad == "Abstract":
        ...
        st.write("Github : [https://github.com/Saaisri/Machine-Learning](https://github.com/Saaisri/Machine-Learning)")
...
if rad == "Dataset":
    ...
    car_dataset = pd.read_csv(r'C:\Users\Saaisri\AppData\Local\Programs\Python\Python39\Scripts\car data.csv')


# In[18]:

# inspecting the first 5 rows of the dataframe
    st.write(car_dataset.head(5))
...
# In[35]:
    ...
    st.title("Linear Regression - Training Data")
...
# In[39]:
    ...
    st.title("Linear Regression - Testing Data")
...
# In[46]:
    ...
    st.title("Lasso Regression - Training Data ")
...
# In[49]:
    ...
    st.title("Lasso Regression - Testing Data")
